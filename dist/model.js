...
export function secdedCheckBits(k){let r=0;while(2**r<k+r+1)r++;return r+1;}
export function softErrorModel(rate,bits,devices,p){
 ...
 return {rawPerDay:raw,physicalRawPerDay:physicalRaw,uncorrectablePerDay:uncorrectable,replicas,storedWordBits};
}
